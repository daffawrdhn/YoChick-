...
func _ready():
	...
	print("DEBUG MODE: play_level_three")
	...
	GLOBALVAR.HP = 100
	GLOBALVAR.three = 0
	GLOBALVAR.three_star_one = false
	GLOBALVAR.three_star_two = false
	GLOBALVAR.three_star_three = false
	GLOBALVAR.Bfood = 100
...
func _process(delta):
	...
	if GLOBALVAR.minum_obat >= 1:
		GLOBALVAR.three_star_one = true
	if GLOBALVAR.suhu_dingin >= 2 && GLOBALVAR.suhu_panas >= 2:
		GLOBALVAR.three_star_two = true
	if GLOBALVAR.makan_ayam >= 3 && GLOBALVAR.minum_ayam >= 3:
		GLOBALVAR.three_star_three = true
	
	if GLOBALVAR.three_star_one == true:
		stars.play("one")
		GLOBALVAR.a_three = 1
		GLOBALVAR.three = 1
		
	if GLOBALVAR.three_star_two == true && GLOBALVAR.three_star_one == true:
		stars.play("two")
		GLOBALVAR.a_three = 2
		GLOBALVAR.three = 2
		
		
	if GLOBALVAR.three_star_three == true && GLOBALVAR.three_star_two == true && GLOBALVAR.three_star_one == true:
		stars.play("three")
		GLOBALVAR.a_three = 3
		GLOBALVAR.three = 3
		over(1)
...
func over(value):
	if value == 1:
		...
		if GLOBALVAR.a_three == 1:
			over_panel.play("one")
		if GLOBALVAR.a_three == 2:
			over_panel.play("two")
		if GLOBALVAR.a_three == 3:
