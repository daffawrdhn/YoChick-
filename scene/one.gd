...
func _ready():
	...
	GLOBALVAR.HP = 100
	GLOBALVAR.one = 0
	GLOBALVAR.one_star_one = false
	GLOBALVAR.one_star_two = false
	GLOBALVAR.one_star_three = false
	GLOBALVAR.Bfood = 100
...
func _process(delta):
	...
	if GLOBALVAR.makan_ayam >= 2:
		GLOBALVAR.one_star_two = true
	if GLOBALVAR.suhu_dingin >= 2:
		GLOBALVAR.one_star_one = true
	if GLOBALVAR.minum_ayam >= 2:
		GLOBALVAR.one_star_three = true
	
	if GLOBALVAR.one_star_one == true:
		stars.play("one")
		GLOBALVAR.a_one = 1
		GLOBALVAR.one = 1
		
	if GLOBALVAR.one_star_two == true && GLOBALVAR.one_star_one == true:
		stars.play("two")
		GLOBALVAR.a_one = 2
		GLOBALVAR.one = 2
		
		
	if GLOBALVAR.one_star_three == true && GLOBALVAR.one_star_two == true && GLOBALVAR.one_star_one == true:
		stars.play("three")
		GLOBALVAR.a_one = 3
		GLOBALVAR.one = 3
		over(1)
...
func over(value):
	if value == 1:
		...
		if GLOBALVAR.a_one == 1:
			over_panel.play("one")
		if GLOBALVAR.a_one == 2:
			over_panel.play("two")
		if GLOBALVAR.a_one == 3:
