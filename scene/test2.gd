...
func _ready():
	...
	GLOBALVAR.stage_level_two = 0
	GLOBALVAR.level_two_star_one = false
	GLOBALVAR.Bfood = 50
	GLOBALVAR.Bwater = 50
...
func _process(delta):
	...
	if GLOBALVAR.level_two_star_one == true:
		stars.play("three")
		one_water.stop()
		GLOBALVAR.level_two = 3
		print("Level two: ", GLOBALVAR.level_two)
		GLOBALVAR.stage_level_two = 3
