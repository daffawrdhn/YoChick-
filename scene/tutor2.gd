...
func _process(delta):
	...
	if GLOBALVAR.minum_ayam == 1:
		GLOBALVAR.tutor_2_star = true
	
	if GLOBALVAR.tutor_2_star == true:
		stars.play("three")
		GLOBALVAR.a_tutor2 = 3
		GLOBALVAR.tutor_2 = 3
		over(1)
...
func over(value):
	if value == 1:
		print("Tutorial 2 Over!")
		over_panel.play("none")
		if GLOBALVAR.a_tutor2 == 3:
