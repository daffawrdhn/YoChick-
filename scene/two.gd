...
func _ready():
	...
	GLOBALVAR.HP = 100
	GLOBALVAR.two = 0
	GLOBALVAR.two_star_one = false
	GLOBALVAR.two_star_two = false
	GLOBALVAR.two_star_three = false
	GLOBALVAR.Bfood = 100
...
func _process(delta):
	...
	if GLOBALVAR.suhu_panas >= 3:
		GLOBALVAR.two_star_two = true
	if GLOBALVAR.suhu_dingin >= 3:
		GLOBALVAR.two_star_one = true
	if GLOBALVAR.makan_ayam >= 2 && GLOBALVAR.minum_ayam >= 2:
		GLOBALVAR.two_star_three = true
	
	if GLOBALVAR.two_star_one == true:
		stars.play("one")
		GLOBALVAR.a_two = 1
		GLOBALVAR.two = 1
		
	if GLOBALVAR.two_star_two == true && GLOBALVAR.two_star_one == true:
		stars.play("two")
		GLOBALVAR.a_two = 2
		GLOBALVAR.two = 2
		
		
	if GLOBALVAR.two_star_three == true && GLOBALVAR.two_star_two == true && GLOBALVAR.two_star_one == true:
		stars.play("three")
		GLOBALVAR.a_two = 3
		GLOBALVAR.two = 3
		over(1)
...
func over(value):
	if value == 1:
		...
		if GLOBALVAR.a_two == 1:
			over_panel.play("one")
		if GLOBALVAR.a_two == 2:
			over_panel.play("two")
		if GLOBALVAR.a_two == 3:
